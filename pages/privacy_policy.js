  ...
  return (
    <Layout title="Privacy policy">
      <div className="bg-white shadow-md rounded-lg px-10 py-6 mt-6">
        <h3 className="text-2xl mb-5">Privacy policy</h3>
        <p>
          Your privacy is important to us. It is Topkymppi&#39;s policy to
          ...
          across our website,{" "}
          <a href="https://topkymppi.com">https://topkymppi.com</a>, and other
        ...
        <h3 className="text-2xl mb-5">Information We Collect</h3>
        <p>
        ...
        <h4 className="text-2xl mb-5">Log Data</h4>
        <p>
        ...
        <h4 className="text-2xl mb-5">Collection and Use of Information</h4>
        <p>
        ...
        <h4 className="text-2xl mb-5">Security of Your Personal Information</h4>
        <p>
        ...
        <h3 className="text-2xl mb-5">Use of Cookies</h3>
        <p>
        ...
        <h3 className="text-2xl mb-5">Limits of Our Policy</h3>
        <p>
        ...
        <h3 className="text-2xl mb-5">Changes to This Policy</h3>
        <p>
